...
import static ru.javawebinar.topjava.util.ValidationUtil.getErrorDescription;
...
//            "meals_unique_user_datetime_idx", EXCEPTION_DUPLICATE_DATETIME);
    ...
    public ErrorInfo handleError(HttpServletRequest req, NotFoundException e, BindingResult result) {
        return logAndGetErrorInfo(req, e, false, DATA_NOT_FOUND, getErrorDescription(result));
    }
...
//                    return logAndGetErrorInfo(req, e, true, DATA_ERROR, messageSourceAccessor.getMessage(entry.getValue()));
//                }
//            }
//        }
    ...
    @ExceptionHandler({IllegalRequestDataException.class, MethodArgumentNotValidException.class,
    ...
    public ErrorInfo illegalRequestDataError(HttpServletRequest req, Exception e, BindingResult result) {
        return logAndGetErrorInfo(req, e, false, VALIDATION_ERROR, getErrorDescription(result));
    }

    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ExceptionHandler(Exception.class)
    public ErrorInfo handleError(HttpServletRequest req, Exception e, BindingResult result) {
        return logAndGetErrorInfo(req, e, true, APP_ERROR, getErrorDescription(result));
    }

    //    https://stackoverflow.com/questions/538870/should-private-helper-methods-be-static-if-they-can-be-static
    static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException,
                                        ErrorType errorType, String errorString) {
