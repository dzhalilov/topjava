...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void createWithLocationWithNotValidData() throws Exception {
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(user))
                .content(JsonUtil.writeValue(getNewWithNotValidData())))
                .andExpect(status().isUnprocessableEntity());
    }

    @Test
    void createWithLocationWithEmptyData() throws Exception {
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(user))
                .content(JsonUtil.writeValue(getNewWithEmptyData())))
                .andExpect(status().isUnprocessableEntity());
    }
